<template>
  <div class="reg">
    <van-nav-bar left-arrow @click-left="$router.push('/login')" title="注册"/>
...
<van-form validate-first ref="regForm">
  ...
  <van-field v-model="password" name="password" type="password" label="密码" placeholder="请输入密码" :rules="[{ validator, message: '请输入规范密码' }]"/>

<!-- 注册 -->
  <div style="margin: 16px;">
    <van-button style="background-color: skyblue;" round block type="info" @click="submit">注册</van-button>
  </div>
  <p style="text-align: center;">已有账号?前往<a href="#" @click="log()">登录</a></p>
</van-form>
...
import { reg,delete_user } from '@/api/user';
